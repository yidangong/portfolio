...
const interviewData = [
    {
        title: "Lack of Time",
        question: "It was difficult for them to find a fixed time period in a day to comfortably learn English because they have job to do and family to take care of. ",
    ...
    },
    {
        ...
        question: "They usually avoid talking to native speakers in both work and life because they are shy to ask for repitition and worried about their accents. ",
    ...
    },
    {
        ...
        question: "Their Children sometimes refuse to talk to them because they are having a hard time understand why their parents cannot speak English and question their identity. ",
    ...
    },
    {
        ...
        question: "They are designated to do jobs not required for fluent English skills which might bring barriers for promotion. ",
    ...
    },
    {
        ...
        question: "Some of them do not have a job and moved to the U.S. because of a change in their husband's work, hence staying at home and taking care of families all the day. ",
...
const opportunityData = [
    {
        ...
        content: "A solution that practice English speaking in a interactive way ",
    },
    {
                ...
                <div className="container insights" id="insights">
                    ...
                    <div className="row">
                        <div className="col-lg-10 col-md-11 col-sm=12 col-xs-12 mx-auto">
                            ...
                            <p className="t_color_bk">New U.S. immigrant workers who are also family caregivers need to improve different English skills sufficiently and get comfortable using them in life and work because they want to integrate into the society and seek for better career opportunities</p>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-10 col-md-11 col-sm=12 col-xs-12 mx-auto">
                            ...
                            <p className="t_color_bk">HMW create tasks that help adults learn English by interacting with their children (they might be native speakers)</p>
                        </div>
                    </div>
